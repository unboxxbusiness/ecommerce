...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className={cn("relative rounded-full border border-transparent dark:border-white/[0.2] bg-white shadow-input flex justify-center items-center space-x-4 px-8 py-2", className)}
    >
      {children}
    </nav>
  );
